...
class CleanupJasaCommand extends Command
{
    protected $signature = 'jasa:cleanup';
    protected $description = 'Cleanup all jasa and create exactly 3 main jasa';

    public function handle()
    {
        $this->info('Starting jasa cleanup...');
        
        // Hapus semua jasa secara paksa
        $this->info('Removing all existing jasa...');
        $this->forceCleanupAllJasa();
        
        // Tambahkan 3 jasa utama
        $this->info('Creating exactly 3 main jasa...');
        $this->createExactlyThreeJasa();
        
        $this->info('Jasa cleanup completed successfully!');
