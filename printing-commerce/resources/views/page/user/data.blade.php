                    ...
                    <div class="card w-100">
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-start">
                                <a href="{{ url('/user/tambah') }}" class="btn btn-success d-flex align-items-center justify-content-center gap-2" id="btnTambah"> 
                                ...
                                <table class="table text-nowrap mb-0 align-middle">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-bottom-0">
                                                <h6 class="fw-semibold mb-1">{{ $user->nama_user }}</h6>
                                            </td>
                                            <td class="border-bottom-0">
                                                <p class="mb-0 fw-normal">{{ $user->jenis_kelamin ?: '-' }}</p>
                                            </td>
                                            <td class="border-bottom-0">
                                                <p class="mb-0 fw-normal">{{ $user->no_telpon ?: '-' }}</p>
                                            </td>
                                            <td class="border-bottom-0">
                                                <a href="{{ url('/user/detail/'.$user->uuid) }}" class="btn btn-warning m-1 btn-detail" style="width: fit-content; height: fit-content; padding: 12px;">
                                                    <img src="{{ asset($tPath.'assets2/icon/detail.svg') }}" alt="">
                                                </a>
                                                <button type="button" onclick="showModalDelete('{{ $user->uuid }}')" class="btn btn-danger m-1 btn-delete" style="width: fit-content; height: fit-content; padding: 12px;">
