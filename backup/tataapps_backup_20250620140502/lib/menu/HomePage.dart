  ...
  Future<List<Review>> fetchReviews() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return _getPlaceholderReviews();
      }
    } catch (e) {
      print('ERROR fetchReviews: $e');
      // Return placeholder reviews instead of empty list
      return _getPlaceholderReviews();
    }
  }
  
  // Helper method to get placeholder reviews when API fails
  List<Review> _getPlaceholderReviews() {
    return [
      Review(
        id: '1',
