...
try {
    if ($type === 'external' && !empty($url)) {
        ...
        $possiblePaths = [
            __DIR__ . '/tataapps/assets/images/inspirasi_desain/' . $file, // Path absolut
            dirname(__DIR__) . '/tataapps/assets/images/inspirasi_desain/' . $file, // Satu level di atas
            __DIR__ . '/../tataapps/assets/images/inspirasi_desain/' . $file, // Relatif
            'C:/laragon/www/Project Tata/tataapps/assets/images/inspirasi_desain/' . $file, // Path absolut hardcoded
        ];
